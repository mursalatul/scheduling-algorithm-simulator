...
// function sjfSimulator(processIds, arrivalTimes, burstTimes) {
//   const n = processIds.length;
//   let placeHolder = document.getElementById("progressContainer");
...
//   // executing the min arrival time process first
...
//   // totalTime = process.burstTime + process.arrivalTime;
//   let executionQueue = [];
//   let completedQueue = [];
...
//       for (let i = 0; i < n; i++) {
//         var iFound = false;
//         for (let j = 0; j < completedQueue.length; j++) {
//           if (i == completedQueue[j]) {
//             iFound = true;
//             break;
//           }
//         }
...
//       const process = executionQueue[i];
//       const targetBar = document.getElementById("P" + (process.originalIndex + 1));
//       const burstTime = process.burstTime;
//       const intervalTime = 1000; // Adjust this value to control speed
//       const totalSteps = burstTime; // The number of steps (updates) to complete the burst
...
//       completedQueue.push(i);
//     }
//     var lessTimesId = [];
//     for (let i = 0; i < n; i++) {
//       if (!completedQueue.includes(i) && processes[i].burstTime <= totalTime) {
//         executionQueue.push(i);
//       }
//     }
//     if (lessTimesId.length) {
//       lessTimesId.sort();
//       executionQueue += lessTimesId;
//     }
//   }
